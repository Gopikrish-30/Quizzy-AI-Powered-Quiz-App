  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:shadow-lg transition-all duration-200">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-blue-700">Advanced Gemini AI generates intelligent questions</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 hover:shadow-lg transition-all duration-200">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="font-bold text-purple-800 mb-2">Instant Feedback</h3>
            <p className="text-sm text-purple-700">Get immediate explanations for each answer</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 hover:shadow-lg transition-all duration-200">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="font-bold text-green-800 mb-2">Professional Results</h3>
            <p className="text-sm text-green-700">Detailed performance analysis and insights</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="backdrop-blur-sm bg-white/95 border-0 shadow-2xl rounded-3xl overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-blue-50 via-purple-50 to-blue-50 border-b border-gray-100 text-center py-8">
        ...
        <CardContent className="p-8 space-y-8">
          ...
          <div className="space-y-4">
            <Label htmlFor="topic" className="text-lg font-semibold flex items-center gap-3">
            ...
            <Input
              ...
              className="bg-white/80 border-2 border-gray-200 focus:border-blue-400 transition-colors text-lg p-4 rounded-2xl"
            />
