...
const QuizInterface: React.FC<QuizInterfaceProps> = ({ quiz, onBackToSetup }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4">
      {/* Header */}
      <div className="mb-8 flex items-center justify-between bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100">
        <Button
          variant="outline"
        ...
        <div className="flex items-center gap-6 text-sm">
          <div className="flex items-center gap-2 bg-blue-50 px-3 py-2 rounded-lg">
            ...
            <span className="font-medium text-blue-800">{formatTime(timeSpent)}</span>
          </div>
